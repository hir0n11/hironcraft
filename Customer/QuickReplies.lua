...
local function SetToastDirection(toast, showLeft)
    ...
    if showLeft then
        ...
        toast.Customer:SetPoint('TOPLEFT', toast, 'TOPLEFT', 12, -8)
        toast.Customer:SetPoint('RIGHT', toast.Portrait, 'LEFT', -4, 0)
        toast.Reply:SetPoint('TOPLEFT', toast, 'TOPLEFT', 12, -26)
        toast.Reply:SetPoint('RIGHT', toast.Portrait, 'LEFT', -4, 0)
        ...
        toast.Customer:SetPoint('TOPLEFT', toast.Portrait, 'TOPRIGHT', 4, -8)
        toast.Customer:SetPoint('RIGHT', toast, 'RIGHT', -12, 0)
        toast.Reply:SetPoint('TOPLEFT', toast.Portrait, 'RIGHT', 4, -8)
        toast.Reply:SetPoint('RIGHT', toast, 'RIGHT', -12, 0)
